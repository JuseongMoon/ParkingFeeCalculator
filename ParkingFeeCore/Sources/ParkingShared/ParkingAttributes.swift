...
public struct ParkingAttributes: ActivityAttributes {
    ...
    public struct ContentState: Codable, Hashable {
        ...
        public init(
            ...
            self.fee = currentFee
            self.discount = discountInfo?.prefix(10).map(String.init)
        ...
        public var discountInfo: String? {
            get { discount }
            set { discount = newValue?.prefix(10).map(String.init) }
        }
